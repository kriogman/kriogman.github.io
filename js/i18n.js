  ...
  var TRANSLATIONS = {
    en: {
      ...
      resume: {
        ...
        quadrant: { desc: 'As part of the SRE team, we built the cloud platform from scratch — full IaC with Terraform, GitOps via ArgoCD, and centralized CI/CD pipelines on GitLab. Reliable infrastructure that runs smooth in the background: teams own their full delivery lifecycle and deploy independently, with no gatekeepers in the way.' },
        '2gether': { desc: 'As SRE at a regulated crypto exchange, I owned cloud infrastructure, observability, and CI/CD end to end — high availability for real-time financial operations, and infrastructure costs consistently moving down.' },
      ...
      page_2gether: {
        ...
        intro: '2gether was a regulated crypto exchange offering cryptocurrency and fiat financial services. As part of the SRE team, I maintained the reliability and scalability of a multi-service AWS infrastructure supporting real-time financial operations for a growing user base.',
      ...
      page_quadrant: {
        ...
        role_title: 'My Role & Responsibilities',
        li1: 'Built multi-environment AWS infrastructure from scratch using IaC with Terraform and Terragrunt — EKS clusters, networking, databases, messaging, and security layers all versioned and reproducible.',
        li2: 'Implemented a GitOps platform with ArgoCD on EKS, managing Dockerized workloads across all environments with automated reconciliation and drift detection.',
        ...
        li7: 'Managed multiple RDS instances including Aurora PostgreSQL — read replicas, RDS Proxy for connection pooling, and automated backup and snapshot strategies across all environments.',
        li8: 'Operated Apache Kafka (MSK) for event streaming across services.',
    ...
    es: {
      ...
      resume: {
        ...
        quadrant: { desc: 'Como parte del equipo SRE, construimos la plataforma cloud desde cero — IaC completa con Terraform, GitOps con ArgoCD y pipelines de CI/CD centralizados en GitLab. Infraestructura fiable que funciona en segundo plano: los equipos son dueños de su ciclo de entrega completo y despliegan de forma independiente, sin bloqueos.' },
        '2gether': { desc: 'Como SRE en un exchange de criptoactivos regulado, me encargué de la infraestructura cloud, la observabilidad y el CI/CD de principio a fin — alta disponibilidad para operaciones financieras en tiempo real y costes en continuo descenso.' },
      ...
      page_2gether: {
        ...
        intro: '2gether era un exchange de criptoactivos regulado que ofrecía servicios financieros en criptodivisas y fiat. Como parte del equipo SRE, mantuve la fiabilidad y escalabilidad de una infraestructura AWS multiservicios que soportaba operaciones financieras en tiempo real para una base de usuarios en crecimiento.',
      ...
      page_quadrant: {
        ...
        role_title: 'Mi Rol y Responsabilidades',
        li1: 'Construimos la infraestructura AWS multi-entorno desde cero con IaC (Terraform + Terragrunt) — clústeres EKS, redes, bases de datos, mensajería y capas de seguridad, todo versionado y reproducible.',
        li2: 'Implementamos una plataforma GitOps con ArgoCD sobre EKS, gestionando cargas de trabajo Dockerizadas en todos los entornos con reconciliación automática y detección de drift.',

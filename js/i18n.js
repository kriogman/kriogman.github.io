  ...
  var TRANSLATIONS = {
    en: {
      ...
      resume: {
        ...
        quadrant: { desc: 'I designed and built the cloud platform from zero — full IaC with Terraform, GitOps via ArgoCD, and centralized CI/CD pipelines on GitLab. Reliable infrastructure that runs smooth in the background: teams own their full delivery lifecycle and deploy independently, with no gatekeepers in the way.' },
        ...
        fintonic: { desc: 'As DevOps/SRE at a personal finance platform operating across Spain and Latin America, I drove a three-year infrastructure overhaul — migrating from IaaS to Kubernetes, building CI/CD pipelines and IaC tooling, and wiring up observability across the full stack. Production stayed up throughout.' },
    ...
    es: {
      ...
      resume: {
        ...
        fintonic: { desc: 'Como DevOps/SRE en una plataforma de finanzas personales con presencia en España y América Latina, lideré una renovación de infraestructura de tres años — migrando de IaaS a Kubernetes, construyendo pipelines de CI/CD y herramientas de IaC, e integrando observabilidad en todo el stack. La producción se mantuvo operativa durante todo el proceso.' },

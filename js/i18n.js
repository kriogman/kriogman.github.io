  ...
  var TRANSLATIONS = {
    en: {
      ...
      resume: {
        ...
        quadrant: { desc: 'Designed and built the cloud platform from zero — full IaC with Terraform, GitOps via ArgoCD, and centralized CI/CD pipelines on GitLab. Reliable infrastructure that runs smooth in the background: teams own their full delivery lifecycle and deploy independently, with no gatekeepers in the way.' },

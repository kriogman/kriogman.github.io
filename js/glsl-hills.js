/**
 * glsl-hills.js — vanilla JS port of the GLSLHills React component
...
(function () {
  ...
  // Ash Grey palette color (0.722, 0.741, 0.714) — visible on dark bg
  var FRAGMENT_SHADER = `
    ...
    void main(void) {
      ...
      vec3 color = vec3(0.722, 0.741, 0.714);
